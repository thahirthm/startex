...
import BannerImg from '../../../../public/assets/images/accounting/book-banner.png'
    ...
    <div className='bg-primary h-auto relative pb-10'>
      <div className='md:flex pt-10 items-center main-pt px-4 md:px-8 lg:px-[90px] relative z-40 gap-20'>
        <div className='md:w-1/2'>
          ...
          Dubai Financial Record Services
            </h6>
          ...
          Accounting and <br />
           ...
           Record monetary transactions securely to optimize the financial resources of your company in Dubai, UAE.
            </p>
