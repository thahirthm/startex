...
import BankBannerImg from '../../../../public/assets/images/workspace/f-banner.png'

import Image from 'next/image'

function FlexiBanner () {
  return (
        ...
        <div className='md:w-1/2'>
          ...
          >
            <h6 className='md:text-[18px] text-[16px] font-[300] text-gradient'>
              Ready-to-Use Office Spaces in Dubai
            </h6>
            <h1 className='md:text-[50px] text-[27px] font-[500] pt-3 text-gradient'>
              Business Center <br />
              Rental service in Dubai, UAE
            </h1>
            <p className='font-[300] md:text-[17px] text-[14px] text-secondary pt-3'>
              Begin your business ventures to establish yourself in Dubai’s
              economic landscape by renting a business center.
            </p>
