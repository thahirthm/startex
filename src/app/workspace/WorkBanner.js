...
import WorkingBannerImg from "../../../public/assets/images/workspace/w-banner.png";
        ...
        <div className="bg-primary h-auto relative pb-10">
            <div className="md:flex pt-10 items-center main-pt px-4 md:px-8 lg:px-[90px] relative z-40 gap-20">
                <div className="md:w-1/2">
                   ...
                   in UAE
                        ...
                        <p className="font-[300] md:text-[17px] text-[14px] text-secondary pt-3">
                          Find office space in a strategic location with Startex to turn the business landscape in favor of your venture
                        </p>
                        <div className="pt-10 flex gap-8">
                            <button className="gr-btn">Office Spaces</button>
                ...
                <div className="md:w-1/2 ms-auto pt-10 md:pt-0">
                    <Image
                        src={WorkingBannerImg}
                        alt="WorkingBannerImg"
                        width={850}
                        height={850}
