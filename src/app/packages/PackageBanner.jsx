...
import BannerImg from "../../../public/assets/images/accounting/p-banner.png";
        ...
        <div className="md:w-1/2">
          ...
          >
            ...
            <p className="font-[300] md:text-[17px] text-[14px] text-secondary pt-3">
              We work through the needs of our clients and provide the most
              viable and affordable rates for the mainland, offshore, and
              freezone packages.
            </p>
