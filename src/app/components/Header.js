...
function Header() {
    ...
    return (
        ...
        >
            <div className="flex gap-10 items-center px-4 md:px-8 lg:px-[70px] pt-7 pb-3">
                {/* Logo */}
                <div>
                    <Link href="/">
                        <Image
                ...
                {/* <div>Current Pathname: {currentPath}</div>  */}
                ...
                >
                    {isMenuOpen ? (
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="36" viewBox="0 0 37 36" fill="none">
                            <line x1="0.646447" y1="35.6464" x2="35.2947" y2="0.998215" stroke="white" />
                            <line x1="1.35355" y1="0.646447" x2="36.0018" y2="35.2947" stroke="white" />
                        </svg>
                    ) : (
                ...
                {/* Navigation Links */}
                <div
                    className={`fixed top-0 left-0 h-full w-full  shadow-lg transform ${isMenuOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"
