...
import BannerImg from "../../../../public/assets/images/licensing/o-banner.png";
        ...
        <div className="md:w-1/2">
          ...
          >
            <h6 className="md:text-[18px] text-[16px] font-[300] text-gradient">
             Explore Offshore License Options in Dubai
            </h6>
            ...
            Opt for an offshore company license in Dubai to unlock boundless opportunities such as 100% ownership, tax benefits, global funding, and more.
