...
function BusinessLicenses() {
  const licenseData = [
    {
      image: Bl,
      heading: "Dubai Mainland License, UAE",
      description: "Setting up a mainland company in Dubai offers lucrative investment opportunities. These businesses operate within Emirati jurisdiction in designated commercial areas.",
      link: "/business-license/mainland-license"
    },
    {
      image: B2,
      heading: "Dubai Freezone License, UAE",
      description: "Freezones in Dubai provide 100% foreign ownership, full repatriation of profits, and world-class infrastructure for businesses of all sizes.",
      link: "/business-license/freezone-license"
    },
    {
      image: B3,
      heading: "Dubai Offshore License, UAE",
      description: "Offshore licenses are ideal for international operations, providing confidentiality, no local office requirements, and tax efficiency.",
