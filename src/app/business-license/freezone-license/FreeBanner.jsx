...
import BannerImg from "../../../../public/assets/images/licensing/f-banner.png";
        ...
        <div className="md:w-1/2">
          ...
          >
            <h6 className="md:text-[18px] text-[16px] font-[300] text-gradient">
              Explore Free Zone License Options in Dubai
            </h6>
            ...
            <p className="font-[300] md:text-[17px] text-[14px] text-secondary pt-3">
              Discover limitless possibilities and own 100% of your business
              with a free zone license, the best option for offshore
              entrepreneurs.
            </p>
