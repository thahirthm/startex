...
import BannerImg from "../../../../public/assets/images/licensing/m-banner.png";

import Image from "next/image";

function MainlandBanner() {
  return (
        ...
        <div className="md:w-1/2">
          ...
          >
            ...
            <p className="font-[300] md:text-[17px] text-[14px] text-secondary pt-3">
              Unlock boundless opportunities in Dubai with your mainland
              company, an ideal option for investors and business
              establishments.
            </p>
