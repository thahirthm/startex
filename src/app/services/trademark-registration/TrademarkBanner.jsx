...
import TradeBannerImg from "../../../../public/assets/images/services/trade-banner.png";

import Image from "next/image";

function TrademarkBanner() {
    return (
                ...
                <div className="md:w-1/2">
                    ...
                    >
                        <h6 className="md:text-[18px] text-[16px] font-[300] text-gradient">
                          Easy Trade License Services in Dubai
                        </h6>
                        ...
                        <p className="font-[300] md:text-[17px] text-[14px] text-secondary pt-3">
                           Acquire a trade license in Dubai, UAE to successfully navigate the city's intricate commerce landscape.
